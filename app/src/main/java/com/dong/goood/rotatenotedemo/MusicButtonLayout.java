...
public class MusicButtonLayout extends RelativeLayout {
    ...
    public MusicButtonLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public MusicButtonLayout(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public void changeAnimStatus() {
        if (state == STATE_PLAYING) {
            ...
            musicAnim.setDuration(MainActivity.DURATION_TIME);
